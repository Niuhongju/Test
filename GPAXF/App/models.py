...
class MainShow(Main):
    '''
    main_show()trackid,name,img,categoryid,brandname,img1,childcid1,productid1,longname1,price1,marketprice1,img2,childcid2,productid2,longname2,price2,marketprice2,img3,childcid3,productid3,longname3,price3,marketprice3
    '''
    class Meta:
    ...
    marketprice1=models.IntegerField(default=0)
    ...
    marketprice2 = models.IntegerField(default=0)
    ...
    marketprice3= models.IntegerField(default=0)
